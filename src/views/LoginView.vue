	...
	<div class="min-h-screen flex items-center justify-center bg-[#0a0c10] px-4">
		<div class="glass-card max-w-md w-full p-10 space-y-8">
			...
			<form @submit.prevent="handleLogin" class="space-y-6">
				<div class="space-y-2">
					<label class="text-xs font-semibold uppercase tracking-widest text-slate-400 ml-1"
						>Email</label
					>
					<input
						v-model="email"
				...
				<div
					v-if="errorMsg"
					class="text-red-400 text-xs text-center font-medium bg-red-400/10 py-3 rounded-xl border border-red-400/20"
				>
					{{ errorMsg }}
				</div>
