...
const BASE_URL = import.meta.env.VITE_API_BASE_URL || "https://us-central1-lienzo360.cloudfunctions.net/api";
...
export const api = {
  ...
  updateProject: (id: string, data: Record<string, unknown>) => apiFetch<ApiResponse<unknown>>(`/projects/${id}`, {
    method: "PUT",
    body: JSON.stringify(data),
  }),
  updateAvailability: (id: string, unit: { id: string; block: string; lot: string; status: string; [key: string]: unknown }) => apiFetch<ApiResponse<unknown>>(`/projects/${id}/availability`, {
    method: "POST",
